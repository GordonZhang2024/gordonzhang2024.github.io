...
BLOG_AUTHOR = "Gordon Zhang"  # (translatable)
BLOG_TITLE = "Gordon Zhang's blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gordonzhang2024.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://gordonzhang2024.github.io/"
BLOG_EMAIL = "jp20171211@163.com"
BLOG_DESCRIPTION = "This is Gordon Zhang's blog."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}, <script src="https://gordonzhang.pythonanywhere.com/static/test.js">'
